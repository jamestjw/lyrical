...
func TestJoinVoiceChannel(t *testing.T) {
	...
	mockDatastore := mock_models.NewMockDatastore(ctrl)
	mockDatastore.EXPECT().GetRandomSongs(gomock.Any()).Return([]models.Song{{Name: "New Song", YoutubeID: "youtubeID"}})

	models.DS = mockDatastore
